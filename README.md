...
Hiveory is currently version `0.1.3`. The repository includes a production Windows build pipeline that creates a portable executable, an NSIS installer, and an MSI package. Local builds are unsigned unless a Tauri signing key is configured.
