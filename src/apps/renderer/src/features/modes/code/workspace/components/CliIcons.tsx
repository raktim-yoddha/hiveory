...
export const CodexIcon: React.FC<CliIconProps> = (props) => (
  <BrandSvg {...props} viewBox="0 0 721 721" color="#f8f8f8">
    <path
...
export const CliBrandIcon: React.FC<CliBrandIconProps> = ({ identifier, ...props }) => {
  ...
  return <Terminal size={props.size ?? 14} className={props.className} style={{ color: '#b8b8b8', flexShrink: 0, ...props.style }} aria-hidden="true" />
}
