...
import { HiveoryBrowserDraw } from '../../../../../global/browser/components/HiveoryBrowserDraw'
import { BrowserAgentDelivery } from '../../../../../global/browser/components/BrowserAgentDelivery'
import {
...
} from '../../../../../global/browser/model/browser-models'
import {
  areBrowserSurfacesSuspended,
  subscribeBrowserSurfaceSuspension,
} from '../../../../../global/browser/model/browser-surface-coordinator'
import { createLatestAsyncQueue, type LatestAsyncQueue } from '../../../../../global/browser/model/latest-async-queue'
import { cancelScheduledBrowserClose, scheduleBrowserClose } from '../../../../../global/browser/model/browser-lifecycle'
...
export const CodePreviewPane: React.FC<CodePreviewPaneProps> = ({ workspaceId, preview, initialUrl = DEFAULT_BROWSER_HOME, onStateChange, onFocus }) => {
  ...
  // normalized by the client and desktop browser manager before opening.
  ...
  const [configuration, setConfiguration] = useState<BrowserConfiguration>({
    ...
    settings: { home_url: DEFAULT_BROWSER_HOME, search_engine: 'google', default_profile_id: 'default', default_viewport_id: 'default' },
  })
