...
export type BrowserEvent = { event: 'state' | 'focused' | 'popup_routed' | 'download_started' | 'download_finished' | 'error'; state: BrowserRuntimeState; notice: string | null }
