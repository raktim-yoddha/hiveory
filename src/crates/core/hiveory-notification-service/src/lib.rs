...
use hiveory_protocol::NotificationSummary;

#[derive(Clone)]
pub struct HiveoryNotificationService {
    persistence: HiveoryPersistence,
    jobs: HiveoryJobRuntime,
}
impl HiveoryNotificationService {
    pub fn new(persistence: HiveoryPersistence, jobs: HiveoryJobRuntime) -> Self {
