...
import { PipelineBoard, ProgressBoard, TaskListBoard } from "@hiveory/taskcomb";
import type { TaskCard } from "@hiveory/taskcomb";
import ADESessionHistory from "@/features/sessions/SessionHistory";
...
export default function KanbanPanel({ open, tasks, statuses = {}, projectPath = null, activeWorkspaceId, onClose }: Props) {
  ...
  return (
    <div
      ...
      className="relative flex flex-col bg-bee-surface/70 backdrop-blur-md border-t border-bee-border/50 shrink-0"
      style={{ height }}
    >
