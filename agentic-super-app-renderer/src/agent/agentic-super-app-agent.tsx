...
export function AgenticSuperAppAgent() {
  ...
  const threads = [
    { id: 'th-1', title: 'agentic-super-app-swift', time: '17m', preview: 'I want you to connect with the f...' },
    { id: 'th-2', title: 'agentic-super-app-swift', time: '20m', preview: 'I need you to help me find lead...' },
  ]

  const agentsList = [
    { id: 'agent-trend', name: 'X trend scout', active: false, hasLiveDot: true },
    { id: 'agent-video', name: 'Trend video strategist', active: false },
    { id: 'agent-charter', name: 'Agentic Super App charter writer', active: false },
