...
import { hiveoryClient, type AgentSummary, type RoutineCreateRequest, type RoutineDetail, type RoutineExecution, type RoutineSummary, type RoutineUpdateRequest } from '../../shared/api/hiveory-client'
  ...
  return <section className="hiveory-automation" aria-labelledby="hiveory-routines-title">
    ...
    <div className="hiveory-automation-layout">
      <div className="hiveory-routine-list" aria-label="Configured routines">
        ...
        </button>) : <div className="hiveory-empty-panel"><CalendarClock size={24} /><p>No routines configured. Create one to put a bounded Agent run on a durable schedule.</p></div>}
      </div>
