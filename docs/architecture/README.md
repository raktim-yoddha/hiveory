...
These documents describe the current Hiveory `0.1.3` implementation. The Rust desktop host owns durable and privileged state; the React renderer is a replaceable projection that communicates through typed Tauri commands and event streams.
