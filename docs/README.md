...
This directory separates current product documentation from historical engineering records. The root [README](../README.md) is the user and developer overview. The documents listed under **Current documentation** describe version `0.1.4` and must be updated whenever their corresponding behavior changes.
